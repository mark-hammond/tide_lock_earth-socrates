! $Id: fv_pack.F90,v 13.0 2006/03/28 21:06:12 fms Exp $
...
! --- FMS ----
   ...
   use mpp_mod, only: mpp_pe, mpp_root_pe, mpp_npes, MPP_VERBOSE, &
        mpp_get_current_pelist, mpp_sync, mpp_error
...
#else
   public :: dry_mass, tra_step, dyn_step
#endif
...
! override number of tracers by reading field_table
    ...
    if ( mpp_pe() == mpp_root_pe() ) write (stdlog(), nml=fv_core_nml)
