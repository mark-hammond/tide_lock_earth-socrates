...
USE socrates_config_mod, only: co2_mix_ratio, n2o_mix_ratio, ch4_mix_ratio,    &
...
USE gas_list_pcf, ONLY: ip_h2o, ip_co2, ip_o3, ip_n2o, ip_ch4, ip_o2, ip_so2,  &
  ip_cfc11, ip_cfc12, ip_cfc113, ip_hcfc22, ip_hfc134a
...
DO i_gas=1, spectrum%gas%n_absorb
  ...
  CASE(ip_h2o)
    DO i=1, n_layer
      DO l=1, n_profile
        atm%gas_mix_ratio(l, i, i_gas) = MAX(h2o(l, i), 0.0_r_def)
      END DO
    END DO
  CASE(ip_co2)
    DO i=1, n_layer
  ...
  CASE(ip_o3)
    DO i=1, n_layer
      DO l=1, n_profile
        atm%gas_mix_ratio(l, i, i_gas) = MAX(o3(l, i), 0.0_r_def)
      END DO
    END DO
  CASE(ip_n2o)
    DO i=1, n_layer
